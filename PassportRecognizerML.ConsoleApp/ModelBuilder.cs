...
namespace PassportRecognizerML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\repo\my\PassportRecognizer\DatasetGenerator\bin\Debug\netcoreapp2.2\dataset.csv";
        private static string MODEL_FILEPATH = @"../../../../PassportRecognizerML.Model/MLModel.zip";
